...
const Skills = () => {
  const languages = ["C", "JavaScript", "Java", "SQL", "Python"];
  const frontend = [
    "HTML",
    "CSS",
    "React",
  ...
  const backend = ["Node.js", "Express.js", "MongoDB", "JWT"];
  const database = ["Prisma", "MySQL", "MongoDB", "PostgreSQL"];
  const tools = ["Git", "GitHub", "VS Code", "Postman"];
  const clouds = ["Vercel", "Netlify", "Render"];
